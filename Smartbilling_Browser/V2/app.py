...
# Data dropdown
PC_LIST = []
# Generate reguler 1-20
#for i in range(1, 27):
    #PC_LIST.append(f"reguler-{i}")

# Generate vip 1-20  
#for i in range(27, 41):
    #PC_LIST.append(f"vip-{i}")

# Generate vvip 1-20
for i in range(41, 66):
    PC_LIST.append(f"vvip-{i}")

WAKTU_LIST_REGULER = ['1', '2', '2.30', '3', '3.40', '5']
WAKTU_LIST_VIP = ['1', '2', '3', '4']
WAKTU_LIST_VVIP = ['1', '1.15', '2', '3', '4', '5', '6', '7', '8', '9', '10']
...
def index():
    if request.method == 'POST':
        ...
        if pc and waktu and aksi and role:
            data = f"{pc}|{waktu}|{aksi}|{role}"
            try:
                ...
                if waktu == "tutup" or aksi == "Tutup Billing":
                    ...
                    log_success(f"{pc} | {aksi} | {waktu} Jam | Role : {role}" )
                    flash("Berhasil", 'success')
                    flash(f"{pc}", 'success')
    ...
    return render_template('index.html', 
                           pc_list=PC_LIST, 
                           waktu_list_reguler=WAKTU_LIST_REGULER,
                           waktu_list_vip=WAKTU_LIST_VIP,
                           waktu_list_vvip=WAKTU_LIST_VVIP, 
                           aksi_list=AKSI_LIST)
