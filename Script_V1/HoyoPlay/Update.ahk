...
; === Informasi Pertama
MsgBox "CTRL + F1 = Click Tengah Lobby Game`n CTRL + F2 = Exit dari Game`n CTRL + F3 = Melakukan Accept Terms`n CTRL + G = Menjalankan Genshin di HoyoPlay`n CTRL + H = Menjalankan Honkai Starrail di HoyoPlay`n CTRL + Z = Menjalankan Zenless Zone Zero di HoyoPlay`nF12 = Keluar Aplikasi"
